...
<head>
	...
	<title>Sekolah Alam Ar-Ridho</title>
...
<!-- CONTENT DUA -->
			<table>
				<tr>
					<center>
					<h3><span>+ Profil Sekolah Menengah Mandiri +</span></h3>
					</center>
				</tr>
				<p>Pada sekolah mandiri ini siswa mendapat kan pelajaran khusus dalam melatih bakat para siswa , dan siswa dapat memilih bakat apa yang di pilih nya ,
				dan sekolah Alam menyediakan beberapa profesi yang akan di pilih oleh para siswa , Sebagai Contoh :</p>
				...
				<p>pada kegiatan di atas siswa mampu mempelajari  hal hal yang belum pernah di lakukann dan pada saat lulus siswa tidak bingung 
				pada apa yang di lakukan pada masa depan saat memilih pekerjaan</p>

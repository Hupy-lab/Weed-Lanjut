...
<!-- CONTENT DUA -->
				...
				<?php
					...
					<?php while ($row=$result->fetch_assoc()): ?>
						<tr>
							...
							<td>
								<a href="Input.php?edit=<?php echo $row['id']; ?>"
									class="btn btn-info">Edit</a>
								<a href="Input.php?delete=<?php echo $row['id']; ?>"
				...
				?>
					...
					<form action ="Input.php" method ="POST">
						<center>
						<h3><span>+ Absen Guru +</span></h3>
						</center>
						<input type="hidden" name="id" class="form-control" value="<?php  echo $id;?>">
						<div class="form-group">
						<center><label>Name Guru</label></center>
						<input type="text" name="name" class="form-control" value="<?php  echo $name;?>" placeholder="Masukan Nama">
						</div>
						<div class="form-group">
						<center><label>Kelas</label></center>
						<input type="text" name="kelas" class="form-control" value="<?php  echo $kelas;?> "placeholder="Masukan Kelas">
						</div>
						<div class="form-group">
						<center><label>Mata Pelajaran</label></center>
						<input type="text" name="mapel" class="form-control" value="<?php  echo $mapel;?> "placeholder="Masukan Kelompok">
						</div>
						<div class="form-group">
						<center><label>Nomor HP</label></center>
						<input type="text" name="nama_guru" class="form-control" value="<?php  echo $nama_guru;?> "placeholder="Masukan Nama Guru">
						</div>
						<div class="form-group">

...
<!-- CONTENT DUA -->
			<table>
				<tr>
					<center>
					<h3><span>+ Lokasi Sekolah & Tentang +</span></h3>
					</center>
				</tr>
                    <p>
                            <ul style="list-style-type:disc">
							<p> + Tentang Sekolah Alam Ar-Ridho + </p>
							  <li>Sekolah Alam Ar Ridho merupakan Sekolah yang berbasis Agama , sekolah ini juga mendidik anak untuk menjadi seorang Enterpreanur sukses, sekolah ini memiliki tiga jenjang seperti : </li>
							...
							<p> + Lokasi + </p>
                              <li>Perumahan Bukit Kencana Jaya, Semarang</li>

                                    Alamat :
                                    <br>
                                    Jl. Kelapa Sawit I Blok AA
                                    <br>
                                    Bukit Kencana Jaya Meteseh
                                    <br>
							...
							<center>
							<img src="map123.png" alt="Trulli" width="600" height="500">
							</center>
                    </p>
			</table>
		</td>

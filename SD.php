...
<!-- CONTENT DUA -->
			<table>
                ...
                <ul style="list-style-type:disc"></ul>
                    ...
                    <center>
                            <h3><span>+ Profil Sekolah Dasar Alam Ar-Ridho +</span></h3>
                    </center>
					<ul style="list-style-type:disc">
							<li>Pada sekolah Alam Ar Ridho seperti sama hal nya SD lain nya yang memiliki tingkatan 6 kelas ,pada sekolah Alam Ar-Ridho memiliki nuansa alam karna ruang kelas yang terbuka dan berdekatan dengan kebun akan tetapi sekolah 
							alam ar ridho memiliki beberapa Kegiatan yang berbeda pada sekolah dasar pada umum nya seperti : </li>
							...
							<p>+ Memanah</p>
							 ...
							 <p>Pada kegiatan Tersebut para murid atau siswa dapat mempelajari hal hal baru yang belum pernah di lakukan nya <p>  
